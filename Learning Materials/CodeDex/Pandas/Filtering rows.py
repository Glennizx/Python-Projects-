...
#Sample - Filtering levels

high_level = characters[characters['level'] > 5]
print(high_level)


#Sample - Filter with AND , OR  --> use "&" for AND. Use "|" for OR
barbarian_high_level = characters[
  (characters['class'] == "Barbarian") &
  (characters['level'] > 1)
]



print(barbarian_high_level)